    ...
    <div style={{ '--accent': accent }} className="min-h-screen bg-zinc-950 text-white font-sans">
      ...
      <section id="contact" className="py-32 px-6">
        <div className="max-w-2xl mx-auto text-center space-y-6">
          <p className="text-[10px] uppercase tracking-[0.4em] font-bold" style={{ color: accent }}>Get In Touch</p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            {studio.phone && (
              <a
                ...
                className="flex items-center gap-3 px-8 py-4 text-xs uppercase tracking-widest font-bold text-white transition-all hover:opacity-80 w-full sm:w-auto justify-center"
                style={{ backgroundColor: accent }}>
            ...
            {studio.email && (
              <a href={`mailto:${studio.email}`}
                className="flex items-center gap-3 px-8 py-4 text-xs uppercase tracking-widest font-bold text-white/60 border border-white/15 hover:border-white/40 hover:text-white transition-all w-full sm:w-auto justify-center">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
