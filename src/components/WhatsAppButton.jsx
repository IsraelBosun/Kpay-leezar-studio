  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {showLabel && (
          <motion.span
            className="bg-zinc-900 text-white text-[11px] uppercase tracking-widest font-bold px-4 py-2 whitespace-nowrap shadow-xl"
      ...
      <motion.a
        ...
        className="w-14 h-14 bg-[#25D366] flex items-center justify-center shadow-xl shadow-black/20 rounded-full"
      ...
      >
        {/* Pulse ring */}
        <motion.span
          className="absolute w-14 h-14 rounded-full bg-[#25D366]/40"
